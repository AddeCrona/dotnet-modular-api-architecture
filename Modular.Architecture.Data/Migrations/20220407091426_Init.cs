        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductNumber = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
                    ProductName = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
                    PaidPrice = table.Column<decimal>(type: "decimal(14,2)", precision: 14, scale: 2, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Price", "ProductName", "ProductNumber" },
                values: new object[,]
                {
                    { 1, 120.50m, "Schampoo deluxe", "T-1234-ab23" },
                    { 2, 119.50m, "Soap deluxe", "T-1654-cf54" },
                    { 3, 59.99m, "Comb", "T-9865-hk94" },
                    { 4, 99.50m, "Toilet paper", "T-4567-tf34" },
                    { 5, 29.99m, "Hair spray", "T-1276-ww33" }
                });
